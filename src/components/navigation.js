export function renderNavigation() {
  const nav = `
    <div class="flex">
      ...
      <div class="w-48 bg-white border-r border-gray-200 h-screen fixed left-0 top-0 z-10 overflow-y-auto">
        <nav class="p-4">
          <div class="flex items-center mb-8 px-4">
            <a href="/" data-link class="text-xl font-bold text-gray-800">Finance App</a>
          </div>
          <ul class="space-y-2">
            <li>
      ...
      <!-- Conteúdo Principal -->
      <div class="ml-48 w-full min-h-screen">
...
export function setupMobileMenu() {
  // Remover configuração de menu mobile, já que agora temos menu lateral
}